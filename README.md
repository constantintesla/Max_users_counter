...
- `content.js` — сбор данных со страницы `web.max.ru`
- `popup.*` — интерфейс всплывающего окна расширения
- `dashboard.*` — дашборд со снимками и динамикой
- `apps-script-code.js` — пример кода для Google Apps Script
...
6. Нажмите "Экспорт в CSV" или "Экспорт в XLSX" для локального сохранения данных
...
Экспорт в XLSX содержит те же колонки, что и CSV:
- Название чата
- Ссылка на чат
- Количество участников
- Количество админов
